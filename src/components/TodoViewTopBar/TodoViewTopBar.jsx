...
import "./TodoViewTopBar.css";

const TodoViewTopBar = () => {
  return (
    <div className="views-top-bar">
      ...
      <div className="todo-view-options">
        <span className="filter">Filter</span>
        <span className="sort">Sort</span>
        <button className="more-options-button">
          {Array.from({ length: 3 }, () => <svg width="2" height="2" viewBox="0 0 2 2" fill="none"
